...
const ICONS = {
  ...
  // 書類フィードバック（👍👎＝良かった/直したい）。装飾絵文字でなく SVG で描く（規約）。
  "thumbs-up": '<path d="M7 10v10H4V10z"/><path d="M7 10l4-6a2 2 0 0 1 2 2v3h5a2 2 0 0 1 2 2.3l-1.2 6A2 2 0 0 1 20.8 20H7z"/>',
  "thumbs-down": '<path d="M17 14V4h3v10z"/><path d="M17 14l-4 6a2 2 0 0 1-2-2v-3H6a2 2 0 0 1-2-2.3l1.2-6A2 2 0 0 1 7.2 4H17z"/>',
